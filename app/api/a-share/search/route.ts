...
const popularStocks = [
  ...
  { code: "sz002432", name: "九安医疗", pinyin: "jayl" },
  { code: "sz300498", name: "温氏股份", pinyin: "wsgf" },
  { code: "sh688981", name: "中芯国际", pinyin: "zxgj" },
  { code: "sh600941", name: "中国移动", pinyin: "zgyd" },
  { code: "sh601899", name: "紫金矿业", pinyin: "zjky" },
  { code: "sz000100", name: "TCL科技", pinyin: "tclkj" },
  { code: "sz000063", name: "中兴通讯", pinyin: "zxtx" },
  { code: "sz002475", name: "立讯精密", pinyin: "lxjm" },
  { code: "sz300124", name: "汇川技术", pinyin: "hcjs" },
  { code: "sz002129", name: "中环股份", pinyin: "zhgf" },
  { code: "sh600406", name: "国电南瑞", pinyin: "gdnr" },
  { code: "sz300760", name: "迈瑞医疗", pinyin: "mryl" },
  { code: "sz002271", name: "东方雨虹", pinyin: "dfyh" },
  { code: "sz300122", name: "智飞生物", pinyin: "zfsw" },
  { code: "sz002460", name: "赣锋锂业", pinyin: "gfly" },
  { code: "sz002352", name: "顺丰控股", pinyin: "sfkg" },
  { code: "sz000538", name: "云南白药", pinyin: "ynby" },
  { code: "sh600588", name: "用友网络", pinyin: "yywl" },
];
